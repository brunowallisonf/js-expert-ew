...
describe("Car Service Suite tests", () => {
    ...
    it("Should choose the first id from carIds in carCategory", async () => {
        ...
        const carIdindex = 0;
        sandbox.stub(carService, carService.getRandomPositionFromArray.name).returns(0)
    ...
    it("Given a CarCategory custom and numberOfDays it should calculate the final amount in real", async () => {
